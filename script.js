...
const badges = {
    10: { emoji: '🌱', text: 'First Sprout' },
    25: { emoji: '🌿', text: 'Growing Strong' },
    50: { emoji: '🌳', text: 'Mighty Oak' },
    75: { emoji: '🎋', text: 'Bamboo Forest' },
    100: { emoji: '🌲', text: 'Century Tree' },
    150: { emoji: '🏆', text: 'Leaf Legend' },
    200: { emoji: '👑', text: 'Leaf Royalty' }
};
...
function showBadge(count) {
    if (badges[count]) {
        ...
        badge.innerHTML = `<span>${badges[count].emoji}</span><span>${badges[count].text}</span>`;
